...
public class Single_endowment extends Fragment implements OnClickListener{
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		View plans=inflater.inflate(R.layout.activity_single_endowment,container,false);
		((Button)plans.findViewById(R.id.apply_single_endow)).setOnClickListener(this);
		return plans;
	}
