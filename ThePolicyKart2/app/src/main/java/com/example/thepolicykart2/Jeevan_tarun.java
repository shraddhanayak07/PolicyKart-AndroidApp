...
public class Jeevan_tarun extends Fragment implements OnClickListener{
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		View plans=inflater.inflate(R.layout.activity_jeevan_tarun,container,false);
		((Button)plans.findViewById(R.id.apply_tarun)).setOnClickListener(this);
		return plans;
	}
