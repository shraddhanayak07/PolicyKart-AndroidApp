...
public class Bima_bachat extends Fragment implements  OnClickListener {
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		View plans=inflater.inflate(R.layout.activity_bima_bachat,container,false);
		((Button)plans.findViewById(R.id.apply_bima)).setOnClickListener(this);
		return plans;
	}
