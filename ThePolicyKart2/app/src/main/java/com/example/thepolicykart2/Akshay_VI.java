...
public class Akshay_VI extends Fragment implements OnClickListener{
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		View plans=inflater.inflate(R.layout.activity_akshay__vi,container,false);
		((Button)plans.findViewById(R.id.apply_akshay)).setOnClickListener(this);
		return plans;
	}
