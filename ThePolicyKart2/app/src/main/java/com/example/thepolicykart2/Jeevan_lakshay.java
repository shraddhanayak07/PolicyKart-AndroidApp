...
public class Jeevan_lakshay extends Fragment implements OnClickListener {
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		View plans=inflater.inflate(R.layout.activity_jeevan_lakshay,container,false);
		((Button)plans.findViewById(R.id.apply_lakshay)).setOnClickListener(this);
		return plans;
	}
