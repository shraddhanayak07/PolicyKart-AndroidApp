...
public class Jeevan_nidhi extends Fragment implements OnClickListener{
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		View plans=inflater.inflate(R.layout.activity_jeevan_nidhi,container,false);
		((Button)plans.findViewById(R.id.apply_nidhi)).setOnClickListener(this);
		return plans;
	}
