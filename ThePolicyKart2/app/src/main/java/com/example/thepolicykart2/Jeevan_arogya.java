...
public class Jeevan_arogya extends Fragment implements OnClickListener{
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		View plans=inflater.inflate(R.layout.activity_jeevan_arogya,container,false);
		((Button)plans.findViewById(R.id.apply_arogya)).setOnClickListener(this);
		return plans;
	}
