...
public class Jeevan_pragati extends Fragment implements OnClickListener {
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		View plans=inflater.inflate(R.layout.activity_jeevan_pragati,container,false);
		((Button)plans.findViewById(R.id.apply_pragati)).setOnClickListener(this);
		return plans;
	}
